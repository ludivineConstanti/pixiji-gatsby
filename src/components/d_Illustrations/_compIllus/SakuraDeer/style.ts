...
import { illuDimensions, zIIlluInFront, illuCustomPos } from "src/styles/g"

const dTree0 = illuDimensions(12, 10)
const pTree0 = illuCustomPos({
  right: { pos: [40] },
  bottom: { pos: [2], sC: "buttonWidth" },
})
...
const pTree1 = illuCustomPos({
  right: { pos: [32] },
  bottom: { pos: [9], sC: "buttonWidth" },
})
...
const pDeer = illuCustomPos({
  right: { pos: [12] },
  bottom: { pos: [0], sC: "buttonWidth" },
})
