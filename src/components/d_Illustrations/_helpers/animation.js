...
export const aAnimateOn = {
  scale: 1,
  transition: { type: "spring", damping: 7.5 },
}
...
export const aAnimateOff = size => ({
  ...
  transition: {
    ...
    repeatType: "mirror",
    ease: "easeInOut",
    repeatDelay: size >= 2 ? 0 : 0.75,
    duration: 1.5,
  },
})

export const aWind = (setter, animation1, columnStart) => {
  setTimeout(() => {
    setter({
      ...animation1,
      animateOn: {
...
export const aShine = (setter, animation1, color, value1, value2) => {
